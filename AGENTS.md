...
This project is indexed by GitNexus as **DovePaw-Lite** (3652 symbols, 6888 relationships, 252 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
